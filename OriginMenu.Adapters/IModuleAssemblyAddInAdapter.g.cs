...
namespace OriginMenu.Adapters
{
    ...
    {
        internal static OriginMenu.Views.IModuleAssembly ContractToViewAdapter(Start9.Api.Contracts.IModuleAssemblyContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleAssemblyContract ViewToContractAdapter(OriginMenu.Views.IModuleAssembly view)
        {
            if ((view == null))
            {
                return null;
