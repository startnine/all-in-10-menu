...
namespace OriginMenu.Adapters
{
    ...
    {
        internal static OriginMenu.Views.IModuleInstance ContractToViewAdapter(Start9.Api.Contracts.IModuleInstanceContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleInstanceContract ViewToContractAdapter(OriginMenu.Views.IModuleInstance view)
        {
            if ((view == null))
            {
                return null;
