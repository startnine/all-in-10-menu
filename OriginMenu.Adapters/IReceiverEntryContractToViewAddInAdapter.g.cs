...
namespace OriginMenu.Adapters
{
    ...
    public class IReceiverEntryContractToViewAddInAdapter : OriginMenu.Views.IReceiverEntry
    {
        private Start9.Api.Contracts.IReceiverEntryContract _contract;
        private System.AddIn.Pipeline.ContractHandle _handle;
        private OriginMenu.Adapters.IMessageEventHandlerViewToContractAddInAdapter MessageReceived_Handler;
        private static System.Reflection.MethodInfo s_MessageReceivedEventAddFire;
		public event System.EventHandler<OriginMenu.Views.MessageReceivedEventArgs>MessageReceived{
			add{
        ...
        public IReceiverEntryContractToViewAddInAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            ...
            MessageReceived_Handler = new OriginMenu.Adapters.IMessageEventHandlerViewToContractAddInAdapter(this, s_MessageReceivedEventAddFire);
        }
        ...
        private event System.EventHandler<OriginMenu.Views.MessageReceivedEventArgs> _MessageReceived;
        ...
        internal virtual void Fire_MessageReceived(OriginMenu.Views.MessageReceivedEventArgs args)
        {
            if ((_MessageReceived == null))
            {
            }
