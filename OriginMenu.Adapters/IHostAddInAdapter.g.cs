...
namespace OriginMenu.Adapters
{
    ...
    {
        internal static OriginMenu.Views.IHost ContractToViewAdapter(Start9.Api.Contracts.IHostContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IHostContract ViewToContractAdapter(OriginMenu.Views.IHost view)
        {
            if ((view == null))
            {
                return null;
