...
namespace OriginMenu.Adapters
{
    ...
    public class IMessageContractToViewAddInAdapter : OriginMenu.Views.IMessage
    {
        ...
        public OriginMenu.Views.IMessageEntry MessageEntry
        {
            get
            {
                return OriginMenu.Adapters.IMessageEntryAddInAdapter.ContractToViewAdapter(_contract.MessageEntry);
            }
        }
