...
namespace OriginMenu.Adapters
{
    ...
    {
        internal static OriginMenu.Views.IMessageContract ContractToViewAdapter(Start9.Api.Contracts.IMessageContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContractContract ViewToContractAdapter(OriginMenu.Views.IMessageContract view)
        {
            if ((view == null))
            {
                return null;
