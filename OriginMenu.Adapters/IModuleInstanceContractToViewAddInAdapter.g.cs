...
namespace OriginMenu.Adapters
{
    ...
    public class IModuleInstanceContractToViewAddInAdapter : OriginMenu.Views.IModuleInstance
    {
        ...
        public OriginMenu.Views.IModule Instance
        {
            get
            {
                return OriginMenu.Adapters.IModuleAddInAdapter.ContractToViewAdapter(_contract.Instance);
            }
        }
