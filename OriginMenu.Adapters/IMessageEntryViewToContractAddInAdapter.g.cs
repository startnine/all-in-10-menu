...
namespace OriginMenu.Adapters
{
    ...
    {
        private OriginMenu.Views.IMessageEntry _view;
        public IMessageEntryViewToContractAddInAdapter(OriginMenu.Views.IMessageEntry view)
        {
            _view = view;
        }
        ...
        internal OriginMenu.Views.IMessageEntry GetSourceView()
        {
            return _view;
        }
    }
