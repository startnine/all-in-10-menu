...
namespace OriginMenu.Adapters
{
    ...
    {
        internal static OriginMenu.Views.IReceiverContract ContractToViewAdapter(Start9.Api.Contracts.IReceiverContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverContractContract ViewToContractAdapter(OriginMenu.Views.IReceiverContract view)
        {
            if ((view == null))
            {
                return null;
